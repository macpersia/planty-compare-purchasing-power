...
import be.planty.compare.purchasingpower.PlantyComparePurchasingPowerServiceApp;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, PlantyComparePurchasingPowerServiceApp.class})
