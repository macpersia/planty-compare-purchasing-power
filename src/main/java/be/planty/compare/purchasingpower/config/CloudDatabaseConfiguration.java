...
@Configuration
@EnableMongoRepositories("be.planty.compare.purchasingpower.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("be.planty.compare.purchasingpower.config.dbmigrations");
